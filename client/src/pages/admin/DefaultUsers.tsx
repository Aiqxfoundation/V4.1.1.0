...
import { 
  ArrowLeft, UserMinus, Search, Settings, Calendar, 
  Hash, ChevronLeft, ChevronRight, Zap, Mail
} from "lucide-react";
...
export default function DefaultUsers() {
  ...
  // Filter for default users (100 MH/s hash power only)
  ...
  // Apply search filter
  const searchedUsers = defaultUsers.filter(u => 
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">Default Users</h1>
              <p className="text-gray-400">
                {isLoading ? "Loading..." : `${defaultUsers.length} users with base hash power (100 MH/s)`}
              </p>
            </div>
          </div>
        </div>
      ...
      <Card className="bg-zinc-900 border-zinc-800">
        <CardHeader>
          <CardTitle className="text-xl text-white">
            {searchQuery 
              ? `Found ${searchedUsers.length} default users matching "${searchQuery}"`
              : `All Default Users (${sortedUsers.length} total)`
            }
          </CardTitle>
        </CardHeader>
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-12">
              <UserMinus className="h-12 w-12 text-gray-500 mx-auto mb-4" />
              <p className="text-gray-400">No default users found</p>
              {searchQuery && (
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <div className="flex gap-1 mt-1">
                                ...
                                {user.miningActive && (
                                  <Badge className="bg-[#f7931a]/20 text-[#f7931a] text-xs">
                                    Mining
                                  </Badge>
                                )}
                              </div>
                        ...
                        <TableCell>
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-500">Base only</p>
                            </div>
                          </div>
                        </TableCell>
